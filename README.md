...
## Unterstützte Rechner:
 ...
 Raspberry 1A(+), 1B(+), 2B, 3A+, 3B(+) direkt mit Raspbian OS (https://downloads.raspberrypi.org/raspbian/images/) oder jedes andere Linux-OS mit APT-Paketverwaltungssystem. 
